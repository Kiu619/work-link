...
// Status config
const statusConfig: Record<JobPostStatus, { color: string; icon: React.ReactNode; label: string }> = {
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-6 pt-4">
        {/* Owner Info */}
        <Card size="small" title={<><UserOutlined className="mr-2" />Thông tin người đăng</>}>
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              ...
              <Space separator={<span className="text-gray-300">|</span>}>
                ...
                <Text type="secondary">ID: {post.userId}</Text>
              </Space>
            </div>
          </div>
        </Card>
        ...
        <Descriptions
          ...
          title={<><TagOutlined className="mr-2" />Chi tiết tin tìm việc</>}
        >
          ...
          {post.workAddress && (
            <Descriptions.Item label="Địa điểm làm việc" span={3}>
              ...
              {post.workRadiusKm && (
                <Text type="secondary" className="ml-2">(Bán kính: {post.workRadiusKm}km)</Text>
              )}
            </Descriptions.Item>
          )}
          ...
          <Descriptions.Item label="Thời gian có thể làm" span={3}>
            <Space>
              <CalendarOutlined />
              <Text>{post.availableFrom.split(' ')[0]}</Text>
              <Text type="secondary">đến</Text>
              <Text>{post.availableTo.split(' ')[0]}</Text>
            </Space>
          </Descriptions.Item>
